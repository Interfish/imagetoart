...
def main(argv):
   inputfile = '/home/ubuntu/input.jpg'
   outputfile = '/home/ubuntu/output.jpg'
   ...
   '''
   This code block is added by Team Codeplay. It will first generate a mask using crfasrnn and then put
   style_person.jpg on to style_background.jpg with mask. This is a course project belongs to Cloud Computing
   and Storage class in University of Florida, Fall 2016
   
   Contact: Ruotong Wang: wrt418@ufl.edu
            Stephen Kirkman: kirkman@ufl.edu
			Xiyuan Gou:  xiyuangou@ufl.edu
   '''
   mask_raw = run_crfasrnn(inputfile,outputfile,gpu_device)
   style_ps = PILImage.open('/home/ubuntu/style-transfer-master/outputs/style_person.jpg')
   style_bg = PILImage.open('/home/ubuntu/style-transfer-master/outputs/style_background.jpg')
   mask = mask_raw.resize(style_ps.size,PILImage.LANCZOS)
   mask = mask.point(lambda i: i==15 and 255)
   style_bg.paste(style_ps,None,mask)
   style_bg.save(outputfile)
